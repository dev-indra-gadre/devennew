...
<div class="span8 offset3">
    <div><h3>Question List</h3></div>
    <?php //echo $this->Form->create('Permission',array('type'=>'file')); ?>


    <fieldset>
        <div><?php echo $this->Form->create('Question',array('type'=>'file')); ?>
...
<?php echo $this->Form->end(); ?>
 ...
 <div style="float:right;margin-right:0%;">
             ...
             <?php echo $this->Html->link('Add Question', ['controller' => $this->request->controller, 'action' => 'add'], ['style' => 'width:120px;','class'=>'submit btn btn-info save']);?>
            </div>
