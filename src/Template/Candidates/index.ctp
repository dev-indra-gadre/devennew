...
<div class="span8 offset3">
    <div><h3>Candidate List</h3></div>
    <fieldset>
        <div><?php echo $this->Form->create('Candidate',array('type'=>'file')); ?>
       ...
       <!--  <th class="info">Address</th> -->
        ...
        <th class="info">Action</th>
         ...
         foreach($candidates as $key=>$result){?>
            ...
            <?php echo $this->Html->link('<i class="icon-edit"></i>',['controller' => 'Candidates', 'action' => 'edit',$result->id, '_full'=>true],['escape' => false,'class'=>'btn btn-success btn-mini']); ?>
             <?php echo $this->Form->postLink('<i class = "icon-remove"></i>', ['controller'=>'Candidates','action' => 'delete',$result->id], ['class' => 'btn btn-default btn-sm btn-danger toolTip btn-mini','escape' => false,'confirm'=>'Are you sure you want to delete Candidate'.$result->id]); ?>
